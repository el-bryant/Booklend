 ...
 * @author Bryyv
 */
public class JIFLookBook_Materia extends javax.swing.JInternalFrame {
    DefaultTableModel modelo;
    Functions.Functions cnn = new Functions.Functions();
    JIFBookEdit bookedit;

    /**
     * Creates new form JIFLookBook_Materia
     */
    public JIFLookBook_Materia() {
    ...
    private void buscar(String texto) {
        try {
            ...
            String sql = "SELECT DISTINCT libro.lib_id, libro.titulo, autor.apellidos || ' ' || autor.nombres, editorial.nombre, libro.materia FROM libro, editorial, autor, escrito WHERE libro.materia LIKE '" + texto + "_%' AND escrito.aut_id = autor.aut_id AND escrito.lib_id = libro.lib_id AND libro.edit_id = editorial.edit_id";
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Buscar Libros por Materia");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        tbLibros.setModel(modelo);
        try {
            String sql = "SELECT DISTINCT libro.lib_id, libro.titulo, autor.apellidos || ' ' || autor.nombres, editorial.nombre, libro.materia FROM libro, editorial, autor, escrito WHERE libro.edit_id = editorial.edit_id AND escrito.aut_id = autor.aut_id AND escrito.lib_id = libro.lib_id AND libro.materia = '" + txtMateria.getText() + "'";
            PreparedStatement ps = cnn.getCnn().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            Object datos[] = new Object[5];
            while (rs.next()) {
    ...
    private void txtMateriaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMateriaKeyReleased
        String texto = txtMateria.getText();
        buscar(texto);
