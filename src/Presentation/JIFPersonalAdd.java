 ...
 * @author Bryyv
 */
public class JIFPersonalAdd extends javax.swing.JInternalFrame {
JIFPersonalShow personalshow;
Functions.Functions cnn = new Functions.Functions();
public static char pass;

    /**
     * Creates new form JIFPersonalAdd
     */
    public JIFPersonalAdd() {
        initComponents();
        cargarCargos();
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Añadir un nuevo colaborador");
        setToolTipText("");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cboCargo, 0, 280, Short.MAX_VALUE)
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        if (txtDni.getText().equals("") || txtApellidos.getText().equals("") || txtNombres.getText().equals("") || txtLogin.getText().equals("") || txtPassword.getText().equals("") || cboCargo.getSelectedIndex() < 1) {
            ...
            obj.setCarg_id(cboCargo.getSelectedIndex());
    ...
    private void txtLoginKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtLoginKeyTyped
        ...
        if (caracter != '\b' && (!Character.isLetter(caracter)) && caracter != KeyEvent.VK_SPACE || txtLogin.getText().length() >= 12) {
            ...
            if (Character.isUpperCase(caracter)) {
                String cad = ("" + caracter ).toLowerCase();
                caracter = cad.charAt(0);
                evt.setKeyChar(caracter);
            }
        }
