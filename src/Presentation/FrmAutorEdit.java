 ...
 * @author Bryyv
 */
public class FrmAutorEdit extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        for (int i = 0; i < tbAutores.getSelectedRowCount(); i ++) {
            ...
            JIFBookEdit.cboAutores.addItem(apellidos + ' ' + nombres);
        }
        this.hide();
        JIFBookEdit.txtNombre.setEnabled(true);
        JIFBookEdit.btnAutores.setEnabled(true);
        JIFBookEdit.cboAutores.setEnabled(true);
        JIFBookEdit.cboEditorial.setEnabled(true);
        JIFBookEdit.txtIsbn.setEnabled(true);
        JIFBookEdit.btnPortada.setEnabled(true);
        JIFBookEdit.cboMateria.setEnabled(true);
        JIFBookEdit.txtLugar.setEnabled(true);
        JIFBookEdit.txtYear.setEnabled(true);
        JIFBookEdit.txtCantPags.setEnabled(true);
        JIFBookEdit.txtCode.setEnabled(true);
        JIFBookEdit.cboTipoLibro.setEnabled(true);
        JIFBookEdit.txaContenidos.setEnabled(true);
        JIFBookEdit.btnGuardar.setEnabled(true);
        JIFBookEdit.btnSalir.setEnabled(true);
        JIFBookEdit.cboEditorial.requestFocus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmAutorEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAutorEdit().setVisible(true);
            }
        });
    }
