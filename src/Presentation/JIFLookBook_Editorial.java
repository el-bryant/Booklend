 ...
 * @author Bryyv
 */
public class JIFLookBook_Editorial extends javax.swing.JInternalFrame {
    DefaultTableModel modelo;
    Functions.Functions cnn = new Functions.Functions();
    JIFBookEdit bookedit;

    /**
     * Creates new form JIFLookBook_Editorial
     */
    public JIFLookBook_Editorial() {
    ...
    private void initComponents() {
        ...
        setIconifiable(true);
        setMaximizable(true);
        setTitle("Buscar libros por Nombre de la Editorial");

        jLabel1.setFont(new java.awt.Font("Gadugi", 0, 14)); // NOI18N
        jLabel1.setText("Ingrese el nombre de la editorial a buscar");
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        ...
        tbLibros.setModel(modelo);
        try {
            String sql = "SELECT libro.lib_id, libro.titulo, autor.apellidos || ' ' || autor.nombres, editorial.nombre, libro.materia FROM libro, editorial, autor, escrito WHERE libro.edit_id = editorial.edit_id AND escrito.aut_id = autor.aut_id AND escrito.lib_id = libro.lib_id AND editorial.nombre = '" + txtEditorial.getText() + "'";
            PreparedStatement ps = cnn.getCnn().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
            Object datos[] = new Object[5];
            while (rs.next()) {
    ...
    private void buscar(String texto) {
        try {
            ...
            String sql = "SELECT DISTINCT libro.lib_id, libro.titulo, autor.apellidos || ' ' || autor.nombres, editorial.nombre, libro.materia FROM libro, editorial, autor, escrito WHERE libro.edit_id = editorial.edit_id AND escrito.aut_id = autor.aut_id AND escrito.lib_id = libro.lib_id AND editorial.nombre LIKE '" + texto + "_%'";
    ...
    private void txtEditorialKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtEditorialKeyReleased
        String texto = txtEditorial.getText();
        buscar(texto);
